...
const problems = [
  ...
  'ไม่รู้ว่าช่วงเวลาไหนลูกค้าแน่น วางแผนพนักงานไม่ได้',
  'ข้อมูลลูกค้าหายเมื่อกระดาษเสียหาย หรือพนักงานลาออก',
]
...
const solutions = [
  ...
  'เห็นกราฟ Busy Hours ล่วงหน้า วางแผนได้ทุกวัน',
  'ข้อมูลเก็บบนคลาวด์ ค้นหาย้อนหลังได้ทุกเมื่อ',
]
